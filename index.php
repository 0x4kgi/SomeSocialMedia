...
<body class="w3-light-grey">
	...
	<div class="w3-row"> 
        <!-- space buffer --> <div class="w3-col" style="width: 5px"><br></div>	
		...
		<!-- post box end -->
			...
			?> 
                 <div class="w3-card w3-white" id="<?php echo $pid; ?>"> <!-- profile post display start -->
				...
				<br>					
            <?php $count++; } ?> <!-- PHP Post loop ends here -->
			
			</div> <!-- w3-rest for posts end here -->
			<div id="bottom"></div>
			<!-- space buffer --> <div class="w3-col w3-right" style="width: 5px"><br></div>	
